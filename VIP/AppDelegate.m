...
-(void)initAppKey{
    [AMapNaviServices sharedServices].apiKey =MAPAPPKEY ;
...
//-(void)isLogin
//{
//    NSString * userName = [kDefaults objectForKey:kUserName];
//    NSString * passWord = [kDefaults objectForKey:kPassWord];
//    
//    //账号密码不为空，则肯定是正确的，不需要联网验证，就可以直接登录了
...
{
    if ([WCDeviceDirectionTool shareDeviceDirection].isVertical) {
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.wancuninfo.VIP" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"VIP" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"VIP.sqlite"];
    NSError *error = nil;
